...
export const Util = {
	...
	dectobin: function(d){
		return Util.hextobin(Util.dectohex(d));
	},
	bintodec: function(b){
		return Util.hextodec(Util.bintohex(b));
	},
	hextodec: function(h){
		return parseInt(h, 16);
	},
	dectohex: function(d, padding){
	...
	dectoascii: function(d){
		return Util.hextoascii(Util.dectohex(d))
	},
	bintoascii: function(b){
		return Util.hextoascii(Util.bintohex(b))
	},
	reversebin: function(input){
		var out = "";
...
export const Offsets = {
	characterHeader: "54494e55", //TINU
	characterFooter: "ff49464552", //YIFER
	characterId: "ffff04",
	fBlockStart: "32ffff",
	fBlock: "ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff",
	fBlockDLC: "ffff00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff",
	itemHeader: '4e4152540460' //NART.`
}

export var file = {
	str: null,
	unitNumberAlive: null,
	totalUnitID: null,
	units: [],
	indexes: null,
	items: ''
